...
@section('title', 'Remake Barber - Contact')
@section('contact-active', 'active')

@section('content')

    @include('theme.partials.hero', ['heroTitle' => 'Contact Us'])
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    ...
                    @endif
                    <form action="{{ route('contact') }}" class="form-contact contact_form" method="post" id="contactForm">
                        @csrf
                        <div class="row">
                            <div class="col-lg-5">
